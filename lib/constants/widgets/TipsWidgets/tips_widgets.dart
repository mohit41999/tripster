...
class TipsWidgetWithFollow extends StatelessWidget {
  const TipsWidgetWithFollow({
    Key? key,
  }) : super(key: key);
...
class TipsWidgetPaidWithFollow extends StatelessWidget {
  const TipsWidgetPaidWithFollow({
    Key? key,
  }) : super(key: key);
...
class TipsWidgetWithFollowEditAnnalysis extends StatelessWidget {
  const TipsWidgetWithFollowEditAnnalysis({
    Key? key,
  }) : super(key: key);
...
class TipsWidgetComboPick extends StatelessWidget {
  const TipsWidgetComboPick({
    Key? key,
  }) : super(key: key);
              ...
              children: [
                ...
                Row(
                  ...
                  children: [
                    ...
                    Icon(Icons.close, color: appThemelightPink)
                  ],
                ),
                SizedBox(
                  height: 10,
